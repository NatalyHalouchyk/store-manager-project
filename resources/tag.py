...
class Tag(MethodView):
    ...
    @blp.alt_response(400, description="Tag is assigned to one or more items and cannot be deleted.")
...
class LinkTagsToItems(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        if item.store.id != tag.store.id:
            abort(400, message="Make sure item ans tag belong to the same store before linking.")
        ...
        try:
            ...
            abort(500, message="An error occurred while adding the tag.")
